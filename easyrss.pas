...
type
  ...
  public
    ...
    property Contentencoded: string read Fcontentencoded write Fcontentencoded;
...
begin
  Result :=
    ...
    FormatTag(Fcontentencoded, 'content:encoded')+
    '		</item>'+#10;
end;
...
begin
  try
    ...
    begin
      ...
      VRssItem.Contentencoded := GetTagValue(VXmlItem, 'content:encoded');
